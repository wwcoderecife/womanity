            ...
            <fieldset>
               ...
               <div class="form-group">
                    <label class="radio-inline">
                       <input type="radio" name="zona" value="sim" class="form-control-radio">Sim
                    </label>

                    <label class="radio-inline">
                        <input type="radio" name="zona" value="nao" class="form-control-radio">Nāo
                    </label>
                </div>
                ...
                <h5>A sua iniciativa está localizada na…*</h5>
                 <div class="form-group">
                    <label class="radio-inline">
                       <input type="radio" name="zona" value="Zona Rural" class="form-control-radio">Zona Rural
                    </label>

                    <label class="radio-inline">
                        <input type="radio" name="zona" value="Zona Urbana" class="form-control-radio">Zona Urbana
                    </label>
                </div>
