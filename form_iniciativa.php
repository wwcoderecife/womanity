           ...
           <h5>1. A sua iniciativa está dentro de uma organização juridicamente constituída?*</h5>
               ...
               <label id="msgCnpj"></label>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="organizacao-telefone" onblur="ExitField('inputTel3','msgTel3','Telefone inválido, número deve conter 14 caracteres ', 14);" required  placeholder="(xx) xxxx-xxxx"class="f1-last-name form-control phone_with_ddd" id="inputTel3">
...
<span id="contando4" style="font-family:verdana;"></span><br/>
            ...
            <fieldset class="tab indicacao">
                ...
                <div class="form-group">
                    <label class="sr-only" for="f1-last-name">E-mail</label>
                    <input type="email" name="indica_email_2" placeholder="email@email.com" class="f1-last-name form-control" id="emailIndica2" >                    
                </div>
                 <h5>Telefone</h5>
                <div class="form-group">
                    <label class="sr-only" for="f1-last-name">Telefone</label>
                ...
                <div class="form-group">
                    <label class="sr-only" for="f1-last-name">E-mail</label>
                    <input type="email" name="indica_email_3" placeholder="email@email.com" class="f1-last-name form-control" id="emailIndica3">
                </div>
                 <h5>Telefone</h5>
                <div class="form-group">
                    <label class="sr-only" for="f1-last-name">Telefone</label>
