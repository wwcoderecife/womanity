    	 ...
    	 <form role="form"  action="classes/prepare_cadastro.php" method="post" class="f1 form-ong">
            ...
            <fieldset class="tab dados_pessoais" >
                ...
                <div class="form-group">
                    ...
                    <input type="tel" pattern="^\d{2}-\d{5}-\d{4}$" name="celular_1" placeholder="(xx) xxxxx-xxxx" class="f1-last-name form-control phone_with_dddcel" id="inputCel1" required >
                ...
                <div class="form-group">
                    <label class="sr-only" for="f1-last-name">Celular</label>
                    <input type="tel"  pattern="^\d{2}-\d{5}-\d{4}$"  name="celular_2" placeholder="(xx) xxxxx-xxxx" class="f1-last-name form-control phone_with_dddcel" id="inputCel2"required >
