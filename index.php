                        ...
                        <form role="form" data-toggle="validator" action="index.php" method="post" class="f1">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" placeholder="Senha *" onkeypress=" return validasenha(this,label);" class="f1-password form-control" id="senha" maxlenght="6" required data-error = "Mínimo de seis (6) digitos">
                                ...
                                function validasenha(campotext,campospan ){
