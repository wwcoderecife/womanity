                        ...
                        <form role="form" data-toggle="validator" action="index.php" method="post" class="f1">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="carta_principios" data-error="Você deve marcar este campo!" value="1" required>Marque este item.
                                            <ul>
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="politica_privacidade" data-error="Você deve marcar este campo!"  value="1" required>Marque este item.
                                            <ul>
